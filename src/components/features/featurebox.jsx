...
const Featurebox = () => {
    ...
    const toggleVisibility = () => {
        setVisible(!visible);
        // const summary = document.querySelector('.accordion-summary');
        // if (visible) {
    ...
    return (
        <div className='container bg-gray-850 shadow-white-lg p-6'>
            ...
            {/* <div className={`transition-all duration-300 ease-in-out ${visible ? 'transform scale-110 bg-gray-200' : 'bg-red'}`} onClick={toggleVisibility}>
                Me
            </div> */}

            {/* Accordian-Summary  */}
            <div className={`accordion-summary overflow-hidden transition-all duration-300 ease-in-out  ${visible ? 'max-h-full' : 'max-h-0'} `}>
